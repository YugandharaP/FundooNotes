...
public class MailService {
	private static final String adminMailId = "dharaparanjape.1007@gmail.com";
	private static final String adminPassword = "dhara1007";
	...
	public static void sendMail(String userEmail, String userPassword) {
	 ...
	 */
	@SuppressWarnings("static-access")
	public static boolean sendMailForActivation(String userEmail, String validToken) {
		Properties properties = new Properties();
		properties.put("mail.smtp.host", "smtp.gmail.com");
		// below mentioned mail.smtp.port is optional
		properties.put("mail.smtp.port", "587");
